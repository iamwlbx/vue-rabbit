...
const changeDialog = ref(false)//修改地址
const addDialog = ref(false)//添加地址

const activeAddress = ref({})
const switchAddress = (item) => {
  // curAddress.value.isDefault = 1
  activeAddress.value = item
  // curAddress.value.isDefault = 0
}
//确定按钮
const confirmAddress = (item) => {
...
<template>
      ...
      <div class="wrapper">
        ...
        <div class="box-body">
          <div class="address">
            ...
            <div class="action">
              <el-button size="large" @click="changeDialog = true">切换地址</el-button>
  ...
  <!-- 切换地址对话框:dialog=>可以绑定v-model，true时显示 -->
  <el-dialog title="切换收货地址" width="30%" center v-model="changeDialog">
