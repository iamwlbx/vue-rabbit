    ...
    <div class="container" v-if="goodsList.details">
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <el-breadcrumb-item :to="{ path: `/category/${goodsList.categories?.[0].id}` }">{{
            goodsList.categories?.[0].name }} 
          2.v-if
          -->
          <el-breadcrumb-item :to="{ path: `/category/${goodsList.categories[1].id}` }">{{ goodsList.categories[1].name }}
          </el-breadcrumb-item>
          <el-breadcrumb-item :to="{ path: `/category/${goodsList.categories[0].id}` }">{{ goodsList.categories[0].name }}
          </el-breadcrumb-item>
            ...
            <div class="goods-article">
              ...
              <div class="goods-tabs">
                ...
                <div class="goods-detail">
                  ...
                  <!-- 图片 -->
                  <img v-img-lazy="imgs" alt="" v-for="imgs in goodsList.details.pictures" :key="imgs">
                  <!-- <img :src="imgs" alt="" v-for="imgs in goodsList.details.pictures" :key="imgs"> -->
                </div>
              </div>
            </div>
            <!-- 24热榜+专题推荐 -->
